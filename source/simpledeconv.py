...
class DeconvDataSet(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        gt=(gt/np.max(gt)-0.5)*2
        tr=(tr/np.max(tr)-0.5)*2
        #print(gt.shape)
        #print(tr.shape)
        #print(gt.dtype)
        #print(tr.dtype)
...
class Net(nn.Module):
    def __init__(self):
        ...
        #self.conv4 = nn.Conv3d(64, 128, 5, padding=2)
        #self.conv5 = nn.Conv3d(128, 64, 5, padding=2)
        self.conv6 = nn.Conv3d(64, 32, 5, padding=2)
        ...
        self.dec2 = nn.ConvTranspose3d(64, 32, 5, stride=2, padding=2, output_padding=1)
        self.dec1 = nn.ConvTranspose3d(32, 16, 5, stride=2, padding=2, output_padding=1)
...
dataSet=DeconvDataSet('/gdata/zhoutk/Deconv/gtSave', '/gdata/zhoutk/Deconv/trSave', 0, 800)
dataLoader=DataLoader(dataSet, batch_size=4, shuffle=True, num_workers=0)
testSet=DeconvDataSet('/gdata/zhoutk/Deconv/gtSave', '/gdata/zhoutk/Deconv/trSave', 800,100)
