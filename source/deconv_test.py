...
save_path='/gdata/zhoutk/Deconv/params/invalid.pt'
param_path='/gdata/zhoutk/Deconv/params/0517fakedatarealpsf_tv0.1.pt'
...
for epoch in range(1):
    ...
    for i_batch in range(1):
        ...
        if i_batch%50==0:
            ...
            t_output=net(t_input)
            print('time passed for one testing: ',int(time.time())-t)
